# Capability: tailwind-v4-css-setup

## Overview
Configures the CSS entrypoint to use Tailwind v4's `@import "tailwindcss"` directive, ensuring all default responsive breakpoint variants are registered and compatible with v4's plugin architecture.
